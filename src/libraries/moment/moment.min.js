...
! function(a, b) {
	...
	function Za(a) {
		var b = null;
		if (!Fe[a] && "undefined" != typeof module && module && module.exports && !Fe.loading) try {
			b = Be._abbr, Fe.loading = a, require.async("./locale/{momentLang}.js", function(d) {
				delete Fe.loading, $a(b);
			})
		} catch (a) {}
		return Fe[a]
	}
